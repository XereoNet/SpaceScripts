...
URL="https://github.com/SpaceDev/SpaceBukkitPanel/archive/"
# Filename derp
FILENAME="1.2.1.zip"
...
then
	chmod -R 777 SpaceBukkitPanel-*/app/tmp SpaceBukkitPanel-*/app/webroot SpaceBukkitPanel-*/app/Config/database*
	if [ -f /etc/centos-release ]
	then
		chown -R apache:apache SpaceBukkitPanel-*/*
	else
		chown -R www-data:www-data SpaceBukkitPanel-*/*
	fi
	cp -r SpaceBukkitPanel-*/* ./
	cp SpaceBukkitPanel-*/.htaccess ./
	rm $FILENAME
	rm -r SpaceBukkitPanel-*
